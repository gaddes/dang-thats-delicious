...
function loadPlaces(map) {
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        // Create a bounds (for zooming into maps!)
        // This allows us to create a bounding box around all our search results, and then zoom the map to encompass them all
        ...
        var markers = places.map(function (place) {
            var _place$location$coord = _slicedToArray(place.location.coordinates, 2),
                ...
                placeLat = _place$location$coord[1]; // We are using array destructuring!
